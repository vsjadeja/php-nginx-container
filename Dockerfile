...
LABEL Maintainer="Virendra Jadeja <virendrajadeja84@gmail.com>" \
    Description="Lightweight container for PHP based on Alpine Linux."
...
RUN apk --no-cache add php7 php7-fpm php7-mysqli php7-tokenizer php7-json php7-openssl php7-curl \
    ...
    php7-mbstring php7-gd php7-fileinfo php7-pdo_mysql php7-sqlite3 php7-pdo_sqlite php7-opcache nginx supervisor curl
